...
fn nodes_reachable(graph: &UnGraph<NTupleOutput, usize>, start_node: NodeIndex) -> usize {
...
fn evaluate_edges_edges_reachable_count(graph: &mut UnGraph<NTupleOutput, usize>) {
